...
var HotelController = (function (_super) {
    __extends(HotelController, _super);
    ...
    HotelController.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    return [2, hotels_service_1.default.getAll()];
                }
                catch (err) {
                    this.setStatus(500);
    ...
    HotelController.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var resutl;
            return __generator(this, function (_a) {
                resutl = hotels_service_1.default.getById(id);
                if (resutl)
                    return [2, resutl];
                this.setStatus(402);
                return [2];
    ...
    HotelController.prototype.add = function (hotel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                hotels_service_1.default.add(hotel);
                this.setStatus(201);
                return [2];
            });
        });
    };
    HotelController.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var resutl;
            return __generator(this, function (_a) {
                resutl = hotels_service_1.default.getById(id);
    ...
    ], HotelController.prototype, "add", null);
    __decorate([
        tsoa_1.Delete("/{id}")
